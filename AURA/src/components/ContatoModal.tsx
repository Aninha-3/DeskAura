...
const ContactModal: React.FC<ContactModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex justify-between items-center pb-4 border-b border-gray-300 bg-white mb-4">
          <h2 id="modal-title" className="text-2xl font-semibold" style={{ color: PrimaryDark }}>
          ...
          <button
            ...
            style={{ color: PrimaryDark, backgroundColor: 'transparent' }}
            aria-label="Fechar"
          >
            <X className="w-6 h-6" />
          </button>
        ...
        <form onSubmit={handleSubmit} className="p-4">
          ...
          {feedback === 'success' && (
            <div className="text-green-700 font-semibold mt-10 text-center">
              Sua mensagem foi enviada com sucesso! Em breve nossa equipe entrará em contato.
            </div>
          )}
          {feedback === 'error' && (
            <div className="text-red-700 font-semibold mt-4 text-center">
